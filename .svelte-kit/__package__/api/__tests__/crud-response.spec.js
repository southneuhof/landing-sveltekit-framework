...
import { createModelCreateHandler, createModelDeleteHandler, createModelDetailHandler, createModelListHandler, createModelReorderHandler, createModelUpdateHandler, createModelVerifyHandler, } from '../index.js';
const model = 'article';
...
function createConfig(prisma, modelConfig = baseModelConfig) {
    return {
        prisma,
        modelConfigs: {
